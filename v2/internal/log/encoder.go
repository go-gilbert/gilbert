...
func (enc JSONEncoder) EncodeDiagnostics(_ []byte, diags hcl.Diagnostics, buff *buffer.Buffer) error {
...
func (enc ColorEncoder) EncodeDiagnostics(data []byte, diags hcl.Diagnostics, buff *buffer.Buffer) error {
...
func (enc TextEncoder) EncodeDiagnostics(data []byte, diags hcl.Diagnostics, buff *buffer.Buffer) error {
	lines := bytes.Split(data, []byte{'\n'})
